    ...
    <div>
      ...
      <header className="text-center py-12">
        ...
        <p className="max-w-2xl mx-auto text-gray-600">
          Un vistazo a trabajos recientes y experimentos personales.
        </p>
      </header>
            ...
            >
              ...
              <div className="relative z-10 p-6 flex flex-col h-full bg-white/60 backdrop-blur">
                <div className="flex flex-wrap gap-2 mb-2">
                  {project.stack && project.stack.map((t) => (
                    <span
                      key={t}
                      className="bg-[#D7FB00] text-black text-xs font-bold px-2 py-0.5 rounded"
                    >
                      {t}
                    </span>
                  ))}
                ...
                <Link to={`/projects/${project.slug}`} className="btn w-max mt-auto">
                  Ver proyecto
                </Link>
              </div>
            </div>
